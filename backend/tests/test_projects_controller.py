...
from src.api.schemas.projects_schema import ProjectCreate, ProjectUpdate
from src.api.schemas.documents_schema import DocumentCreate
from src.api.schemas.selections_schema import SelectionCreate
from src.api.enums import FileType, ProjectStatus, ScopeType, CommitState
from src.core.security import security_manager
from src.db.models import Project as ProjectModel, Document as DocumentModel, File as FileModel
from src.core.pdf_redactor import generate_test_pdf
from src.crud import selections_crud
...
class TestProjectsController:
    ...
    def test_redact_stream_rerun_replaces_redacted(self, client, test_session: Session):
        ...
        from src.api.enums import FileType as FT
        reds1 = (
            test_session.query(FileModel)
