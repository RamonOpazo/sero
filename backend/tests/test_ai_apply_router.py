...
from src.db.models import Project as ProjectModel, File as FileModel
...
def test_api_apply_ai_and_stage_selections(client, test_session: Session, monkeypatch):
    ...
    from src.api.controllers import documents_controller as dc
    ...
    # Patch both the module and the controller's bound reference to be extra safe
