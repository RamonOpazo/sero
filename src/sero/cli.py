...
def main():
    ...
    setup_parser.add_argument("-d", "--project-description", type=str, required=False, help="project description")
    ...
    setup_parser.add_argument("-p", "--crop-pages", type=str, required=False, help="pages to crop; use 'N:M' for ranges; use 'N,M' for separation")
    setup_parser.add_argument("-H", "--marker-header", type=str, required=False, help="identification marker prefix")
    setup_parser.add_argument("-P", "--marker-position", type=int, nargs=2, required=False, help="identification marker position; starts at (0, 0) from the top-left corner of the cropping area")
    setup_parser.add_argument("-S", "--marker-size", type=int, required=False, help="identification marker font size")
    setup_parser.add_argument("-C", "--marker-color", type=str, required=False, help="identification marker font color")
    ...
    test_parser.add_argument("-p", "--crop-pages", type=str, required=False, help="pages to crop; use 'N:M' for ranges; use 'N,M' for separation")
    test_parser.add_argument("-r", "--regex", type=str, required=False, help="test regular expression for structured data extraction of cropped information")
    ...
    crop_parser.add_argument("-p", "--crop-pages", type=str, default=False, help="override default pages to crop; use 'N:M' for ranges; use 'N,M' for separation")
