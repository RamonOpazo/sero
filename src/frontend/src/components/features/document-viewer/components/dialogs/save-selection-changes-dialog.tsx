            ...
            <AlertDescription>
              <div className="space-y-2">
                ...
                <ul className="list-outside list-disc text-sm text-muted-foreground pl-4">
                  <li>All new selections will be permanently created</li>
                  <li>All modified selections will be updated</li>
                  <li>All deleted selections will be removed from the server</li>
