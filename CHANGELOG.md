...
- Dockerfile ([#45](https://github.com/RamonOpazo/sero/pull/45),
  [`f0c52bb`](https://github.com/RamonOpazo/sero/commit/f0c52bb011dae370407c1a105ec24d6aa0af41e2))
...
* fix: push Docker image only when a release is created (gate steps on semrel.outputs.released)
  (#35)

* 1.9.3

* fix: caching and naming (#38)

* 1.9.4

* fix: setuptools scm (#39)

* 1.9.5

* fix: setuptools scm pretend version (#40)
...
* release: write static version into backend/pyproject.toml from semantic-release to avoid VCS
  versioning in Docker build

* docker: copy LICENSE to /app and backend under /app/backend so pyproject license path ../LICENSE
  resolves; uv sync now works

* 1.9.7

* ci: fix workflow YAML issues and align with release pipeline
...
- Docker app versioning ([#42](https://github.com/RamonOpazo/sero/pull/42),
  [`2df7e6b`](https://github.com/RamonOpazo/sero/commit/2df7e6b5c2e893b957aff79408b6c0ee5274bc9f))
